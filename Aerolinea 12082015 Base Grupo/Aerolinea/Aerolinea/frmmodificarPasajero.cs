    ...
    public partial class frmmodificarPasajero : Form
    {
        ...
        private void funbuscarPasajeroAModificar()
        {
            using (clasconexion.funobtenerConexion())
            {
                ...
                claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Busco pasajero a modificar", "MaPasajero");
        ...
        private void funmodificarPasajero()
        {
            ...
            using (clasconexion.funobtenerConexion())
            {
                try
                {
                    ...
                    //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                    claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Modifico Pasajero", "MaPasajero");
                    //FIN iNGRESO bITACORA
                    clasconexion.funobtenerConexion().Close();
        ...
        private void funllenarCombocorreos()
        {
            using (clasconexion.funobtenerConexion())
            {
                ...
                //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Busco registro", "TrCorreo");
                //FIN iNGRESO bITACORA
                clasconexion.funobtenerConexion().Close();
        ...
        private void btnnuevoTelefono_Click(object sender, EventArgs e)
        {
            using (clasconexion.funobtenerConexion())
            {
                ...
                //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Ingreso Nuevo Telefono", "TrTelefono");
                //FIN iNGRESO bITACORA
                clasconexion.funobtenerConexion().Close();
        ...
        private void funmodificoTelefono()
        {
            using (clasconexion.funobtenerConexion())
            {
                try
                {
                    ...
                    //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                    claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Modifico Telefono", "TrTelefono");
                    //FIN iNGRESO bITACORA
                    clasconexion.funobtenerConexion().Close();
        ...
        private void funeliminartelefono()
        {
            using (clasconexion.funobtenerConexion())
            {
                try
                {
                    ...
                    //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                    claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Elimino Telefono", "TrTelefono");
                    //FIN iNGRESO bITACORA
                    clasconexion.funobtenerConexion().Close();
