    ...
    public partial class frmcontrolAvion : Form
    {
        ...
        private void funeliminar() {
            try {
                ...
                claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Elimino Avion", "MaAvion");
        ...
        private void funbuscaravion() {
            try {
                ...
                grdaviones.AutoResizeColumns();
                //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Busco Registro", "MaAvion");
                //FIN iNGRESO bITACORA
                clasconexion.funobtenerConexion().Close();
                funlimpiar();
            }
            ...
            if ((cmbtipoAvion.Text != "") && (txtaerolinea.Text != "") && (txtmatricula.Text != "") && (txtmodelo.Text != ""))
            {
                try
                {
                    ...
                    using (clasconexion.funobtenerConexion())
                    {
                        ...
                        //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERARDO SANTIZO
                        claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Ingreso Avion", "MaAvion");
                        //FIN iNGRESO bITACORA
                        clasconexion.funobtenerConexion().Close();
                        funlimpiar();
                        funconsultarAviones();
