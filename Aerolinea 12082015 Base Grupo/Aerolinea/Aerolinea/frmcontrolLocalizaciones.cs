                ...
                try
                {
                    ...
                    if (txtLugar.Text != "")
                    {
                        using (clasconexion.funobtenerConexion())
                        {
                            ...
                            claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Ingreso Locacion", "TrDestino");
                ...
                try
                {
                    if ((txtAeropuerto.Text != "") && (cmbLugar.Text != ""))
                    {
                        using (clasconexion.funobtenerConexion())
                        {
                            ...
                            //INGRESO BITACORA PROGRAMADOR Y ANALISTA GERADO SANTIZO
                            claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Ingreso Aeropuerto", "MaAeropuerto");
                            //FIN iNGRESO bITACORA
                            clasconexion.funobtenerConexion().Close();
                            funlimpiar();
